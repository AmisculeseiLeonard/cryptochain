...
describe('Transaction', () => {
    ...
    describe('update()', () => {
        ...
        describe('and the amount is invalid', () => {
            it('throws an error', () => {
                expect(() => { transaction.update({ senderWallet, recipient: 'test-recipient', amount: 999999 }) }).
    ...
    describe('rewardTransaction()', () => {
        ...
        it('it creates a transaction with reward input', () => {
            expect(rewardTransaction.input).toEqual(REWARD_INPUT);
        });

        it('creates one transaction for the miner with the `MINER_RATE`', () => {
